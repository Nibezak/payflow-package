...
class AddressRelationManager extends BaseRelationManager
{
    ...
    public function getDefaultTable(Table $table): Table
    {
        return $table
            ->heading(
                __('payflowpanel::address.plural_label')
            )
            ->columns([
                Tables\Columns\TextColumn::make('title')->label(
                    __('payflowpanel::address.table.title.label')
                ),
                Tables\Columns\TextColumn::make('first_name')->label(
                    __('payflowpanel::address.table.first_name.label')
                ),
                Tables\Columns\TextColumn::make('last_name')->label(
                    __('payflowpanel::address.table.last_name.label')
                ),
                Tables\Columns\TextColumn::make('company_name')->label(
                    __('payflowpanel::address.table.company_name.label')
                ),
                Tables\Columns\TextColumn::make('line_one')->label(
                    __('payflowpanel::address.table.line_one.label')
                ...
                Tables\Columns\TextColumn::make('city')->label(
                    __('payflowpanel::address.table.city.label')
                ),
                Tables\Columns\TextColumn::make('state')->label(
                    __('payflowpanel::address.table.state.label')
                ),
                Tables\Columns\TextColumn::make('postcode')->label(
                    __('payflowpanel::address.table.postcode.label')
                ),
                Tables\Columns\TextColumn::make('contact_email')->label(
                    __('payflowpanel::address.table.contact_email.label')
                ),
                Tables\Columns\TextColumn::make('contact_phone')->label(
                    __('payflowpanel::address.table.contact_phone.label')
                ),
            ])->actions([
                    ...
                    ->form([
                        Forms\Components\Group::make()->schema([
                            Forms\Components\TextInput::make('title')->label(
                                __('payflowpanel::address.form.title.label')
                            )->columnSpan(1),
                            Forms\Components\TextInput::make('first_name')->label(
                                __('payflowpanel::address.form.first_name.label')
                            )->columnSpan(2),
                            Forms\Components\TextInput::make('last_name')->label(
                                __('payflowpanel::address.form.last_name.label')
                            )->columnSpan(2),
                        ])->columns(5),
                        Forms\Components\TextInput::make('company_name')->label(
                            __('payflowpanel::address.form.company_name.label')
                        ),
                        Forms\Components\Group::make()->schema([
                            Forms\Components\TextInput::make('line_one')->label(
                                __('payflowpanel::address.form.line_one.label')
                            ),
                            Forms\Components\TextInput::make('line_two')->label(
                                __('payflowpanel::address.form.line_two.label')
                            ),
                            Forms\Components\TextInput::make('line_three')->label(
                                __('payflowpanel::address.form.line_three.label')
                            ),
                        ])->columns(3),
                        Forms\Components\Group::make()->schema([
                            Forms\Components\Select::make('country_id')->label(
                                __('payflowpanel::address.form.country_id.label')
                            )->relationship(
                                name: 'country',
                            ...
                            Forms\Components\TextInput::make('state')->label(
                                __('payflowpanel::address.form.state.label')
                        ...
                        Forms\Components\Group::make()->schema([
                            Forms\Components\TextInput::make('city')->label(
                                __('payflowpanel::address.form.city.label')
                            ),
                            Forms\Components\TextInput::make('postcode')->label(
                                __('payflowpanel::address.form.postcode.label')
                            ),
                        ])->columns(2),
                        Forms\Components\Group::make()->schema([
                            Forms\Components\TextInput::make('contact_email')->label(
                                __('payflowpanel::address.form.contact_email.label')
                            ),
                            Forms\Components\TextInput::make('contact_phone')->label(
                                __('payflowpanel::address.form.contact_phone.label')
                            ),
                        ])->columns(2),
                    ]),
