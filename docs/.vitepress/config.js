    ...
    themeConfig: {
        ...
        nav: [
            ...
            { text: 'Admin Panel', link: '/admin/overview', activeMatch: '/admin/' },
            {
                text: 'Resources',
                items: [
                    { text: 'Add-ons', link: 'https://github.com/payflowphp/awesome' },
                    { text: 'Discord', link: 'https://discord.gg/v6qVWaf' },
                    { text: 'Discussions', link: 'https://github.com/payflowphp/payflow/discussions' }
                ]
            },
            {
                text: '1.x',
                items: [
                    ...
                    { text: 'Roadmap', link: 'https://github.com/orgs/payflowphp/projects/8' },
                    { text: '0.x Docs', link: 'https://v0.payflowphp.io/' },
                ]
            }
        ],
        ...
        socialLinks: [
            { icon: 'github', link: 'https://github.com/payflowphp/payflow' },
            { icon: 'twitter', link: 'https://twitter.com/payflowphp' },
