...
namespace Payflow\Admin\Console\Commands;
...
class MakePayflowAdminCommand extends Command
{
    protected $description = 'Create a new Payflow admin';

    protected $signature = 'payflow:create-admin
