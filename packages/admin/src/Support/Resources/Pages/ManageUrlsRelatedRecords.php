...
class ManageUrlsRelatedRecords extends BaseManageRelatedRecords
{
    ...
    {
        return __('payflowpanel::relationmanagers.urls.title_plural');
    }

    public static function getNavigationIcon(): ?string
    {
        return FilamentIcon::resolve('payflow::urls');
    }
        ...
        return $form
            ->schema([
                Forms\Components\Toggle::make('default')->label(
                    __('payflowpanel::relationmanagers.urls.form.default.label')
                )->columnSpan(2),
                Forms\Components\Group::make([
                    Forms\Components\TextInput::make('slug')
                        ->label(
                            __('payflowpanel::relationmanagers.urls.table.slug.label')
                        )
                        ->required()
                        ->dehydrateStateUsing(
                    ...
                    Forms\Components\Select::make('language_id')->label(
                        __('payflowpanel::relationmanagers.urls.table.language.label')
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\IconColumn::make('default')
                    ->label(
                        __('payflowpanel::relationmanagers.urls.table.default.label')
                    )
                    ->boolean(),
            ])
            ->filters([
                Tables\Filters\SelectFilter::make('language_id')
                    ->label(
                        __('payflowpanel::relationmanagers.urls.filters.language_id.label')
                    )
                    ->relationship('language', 'name'),
            ])
            ->headerActions([
                Tables\Actions\CreateAction::make()->label(
                    __('payflowpanel::relationmanagers.urls.actions.create.label')
                )->after(
