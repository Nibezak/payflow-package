<x-filament-widgets::widget>
  ...
  <div class="space-y-4">
    <div
      ...
      <div class="fi-ta-content divide-gray-200 overflow-x-auto">
        ...
        @else
        <x-filament-tables::empty-state heading="No Product Options Configured" icon="lucide-shapes">
    ...
    <div
      ...
      <div class="fi-ta-content divide-y divide-gray-200 overflow-x-auto dark:divide-white/10 dark:border-t-white/10">
        ...
        @else
        <x-filament-tables::empty-state
          :heading="__('payflowpanel::productoption.widgets.product-options.variants-table.empty.heading')"
  ...
  <div class="space-y-4">
    ...
    @else
    <div>
      <x-payflowpanel::products.variants.product-options-list :items="$configuredOptions" group="product_options"
