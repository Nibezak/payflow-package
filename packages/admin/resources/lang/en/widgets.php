    ...
    'dashboard' => [
        'orders' => [
            'order_stats_overview' => [
                'stat_one' => [
                    'label' => 'Orders today',
                    'increase' => ':percentage% up from :count yesterday',
                    'decrease' => ':percentage% down from :count yesterday',
                    'neutral' => 'No change compared to yesterday',
                ],
                'stat_two' => [
                    'label' => 'Orders past 7 days',
                    'increase' => ':percentage% up from :count last period',
                    'decrease' => ':percentage% down from :count last period',
                ...
                'stat_four' => [
                    'label' => 'Sales today',
                    'increase' => ':percentage% up from :total yesterday',
                    'decrease' => ':percentage% down from :total yesterday',
                    'neutral' => 'No change compared to yesterday',
                ],
                'stat_five' => [
                    'label' => 'Sales past 7 days',
                    'increase' => ':percentage% up from :total last period',
                    'decrease' => ':percentage% down from :total last period',
                    'neutral' => 'No change compared to last period',
                ],
                'stat_six' => [
